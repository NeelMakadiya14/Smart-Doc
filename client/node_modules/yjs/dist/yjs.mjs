...
import { writeVarUint, createEncoder, toUint8Array, writeUint8, writeVarString, writeAny, writeVarUint8Array, IntDiffOptRleEncoder, UintOptRleEncoder, RleEncoder, StringEncoder, writeUint8Array, writeVarInt, writeBinaryEncoder } from 'lib0/encoding.js';
import { readVarUint, readUint8, readVarString, readAny, readVarUint8Array, IntDiffOptRleDecoder, UintOptRleDecoder, RleDecoder, StringDecoder, createDecoder, hasContent, readVarInt } from 'lib0/decoding.js';
...
const encodeStateVectorFromUpdateV2 = (update, YEncoder = DSEncoderV2, YDecoder = UpdateDecoderV2) => {
  ...
  const updateDecoder = new LazyStructReader(new YDecoder(createDecoder(update)), true);
